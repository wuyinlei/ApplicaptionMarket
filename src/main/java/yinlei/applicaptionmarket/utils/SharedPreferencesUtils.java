 ...
 * @FileName: SharedPreferencesUtils.java
 * @author: 若兰明月
 * @date: 2016-06-09 14:47
 */

public class SharedPreferencesUtils {
    public static String PREFERENCE_NAME = AppConstant.SHARE_PATH;
     ...
     * @return True if the new values were successful written to persistent storage
     */
